...
exports.createSauce = (req, res, next) => {
  ...
  const sauce = new Sauce({
      ...sauceObject,
      userId: req.auth.userId,      imageUrl: `${req.protocol}://${req.get('host')}/images/${req.file.filename}`,
      likes: 0,
      dislikes: 0,
      usersLikes: [],
      usersDisliked: []
...
// méthode qui permets à un user de liker - disliker - annuler son like/dislike sur une sauce
